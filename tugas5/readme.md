...
![](https://lh7-us.googleusercontent.com/vbt3NxhzFj6u21y_rKC5ZFoWbJiQG6h_L0rt2f0x6sVVGy1WJSx_HouGiJ4irsP8pglPlaALtr3sxp0oneFEzK-dezXDd_pp8TWDphYhzW51MfJ-dR110OJAPRiRXpuJY7eM-FXrPTZ7cHD2IofsWKc)
...
-   [Unix_Socket] authentication is enabled by default → `show grants for root@localhost;`
...
3.  Choose the option Yes to configure the database for phpmyadmin by itself using bdconfig-common,
...
5.  Create Apache Configuration for phpMyAdmin → `sudo nano /etc/apache2/apache2.conf`
...
-   Lalu → `GRANT ALL PRIVILEGES ON *.* TO 'phpmyadmin'@'localhost' IDENTIFIED BY 'password' WITH GRANT OPTION; FLUSH PRIVILEGES;`
...
![](https://lh7-us.googleusercontent.com/_C_01JLWHKSX0rNxDLyVJckReWvWqRe5cEBn4hWpoAL8XDJxJSmzG2sw7ZBkn5oNmvAoxQjTKeNzx5O9ch1Hv4LGjgNI-rfS_FyE5vCmGqG4mph3dslVEFTf84ky2Y9f6lc1OoxwblZuf8L4m08YdNE)
...
![](https://lh7-us.googleusercontent.com/_wg7bz6su_Zo2EWA1Zd1KDccrVzCzvhLevs5hfoR3_w73VEhV0QbaaKaDtyCvGNGGe0zx82JXql7kX_UIoizZq-NUk4YaterqVKBUFjsefJnznOIy_TJnRP-zJ5LZeEHNMPQ6ydXpjGKHyevsUKy5-E)
...
4.  `sudo mysql -u roundcube -D roundcube -p < mysql` dan masukkan password mariaDB roundcube (password)
